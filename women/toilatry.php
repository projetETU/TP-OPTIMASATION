...
<head>
	...
	<meta name="description" content="toilatry Women">
...
<body>
	...
	<div style="padding: 30px 120px; font-size: 25px; margin: 0 auto; display: table; width: 98%;">
		<div>
		<?php 
		$getposts = $conn->query("SELECT * FROM products WHERE available >= '1' AND item = 'toilatry' ORDER BY id DESC LIMIT 10");
					...
					<ul style="float: left;">
						<li style="float: left; padding: 0px 25px 25px 25px;">
							<div class="home-prodlist-img"><a href="view_product.php?pid=' . $id . '">
								<img  alt= "'.$pName.'" src="../image/product/toilatry/' . $picture . '" class="home-prodlist-imgi" >
								</a>
